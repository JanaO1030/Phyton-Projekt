...
if __name__ == "__main__":
    ...
    for index_sel_col in range(count_ys_selected_ideal):
        ...
        sns.lineplot(x=df_selected_ideals["x"], y=df_selected_ideals.iloc[:, index_sel_col + 1], ax=ax[0, index_sel_col], linewidth=1, linestyle="-")    # row 2: training functions & selected ideal functions
