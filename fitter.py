...
class Fitter:
    ...
    def visualize(self):
        ...
        for sel_col_index in range(self._count_ys_selected_ideal):
            ...
            sns.scatterplot(data=associated_points, x=associated_points["x"], y=associated_points["y"], ax=ax[0, sel_col_index], size=1, legend=False)
            sns.lineplot(x=self._df_selected_ideals["x"], y=self._df_selected_ideals.iloc[:, sel_col_index + 1], ax=ax[0, sel_col_index], linewidth=1, linestyle="-")\
